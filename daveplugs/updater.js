...
const REPO_OWNER = "Courtney250";
const REPO_NAME = "TECHWORD-V1-";
const BRANCH = "main";
...
const update = async (m, Matrix) => {
    ...
    if (cmd === "update") {
        ...
        try {
            ...
            // Update details (as requested: TECHWORD style)
            const authorName = "TECHWORD";
            const authorEmail = "TECHWORD@gmail.com";
