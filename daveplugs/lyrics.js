...
const text = m.body.slice(prefix.length + cmd.length).trim();
  ...
  if (validCommands.includes(cmd)) {
    ...
    try {
      await m.React('🕘');
      await m.reply('A moment, *TECHWORD-md* is generating your lyrics request...');
      ...
      if (result && result.lyrics) {
        ...
        let buttons = [{
          ...
          },
          {
            name: "cta_url",
            buttonParamsJson: JSON.stringify({
              display_text: "show 💜 for TECHWORD",
              url: `https://whatsapp.com/channel/0029Vag99462UPBF93786o1X`
            })
          },
          {
            name: "quick_reply",
