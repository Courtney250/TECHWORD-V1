...
const config = {
  ...
  BOT_NAME: process.env.BOT_NAME || "TECHWORD-XMD",
  BOT: process.env.BOT || "hello 👋",
  NEW_CMD: process.env.NEW_CMD || "ᴀᴅᴅᴠᴀʀ\n│ sᴜᴅᴏ\n| TECHWORD",
  CAPTION: process.env.CAPTION || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ TECHWORD",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by TECHWORD',
  ...
  OWNER_NAME: process.env.OWNER_NAME || "TECHWORD",
